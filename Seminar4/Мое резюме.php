<?php
  $job = [
    'job_name' => ['GB', 'Яндекс', 'ВК'],
    'job_date' => ['2020 - настоящее время', '2018 - 2020', '2010 - 2018'],
    'job_desc' => ['Очень интенсивно', 'Очень интересно', 'Набирался опыта'],
  ];
?>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          ...
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i> <?php echo $job['job_date'][0]; ?> </h6>
          <p> 
        ...
        <div class="w3-container">
          ...
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $job['job_date'][1]; ?></h6>
          <p> <?php echo $job['job_desc'][1]; ?> </p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $job['job_name'][2]; ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $job['job_date'][2]; ?></h6>
